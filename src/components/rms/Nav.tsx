    ...
    >
      <div className="container-rms flex h-16 items-center justify-between gap-6 md:h-18">
        <a href="#top" className="group flex items-center gap-2.5" aria-label="RMS360 home">
          <span className="relative grid size-8 place-items-center rounded-sm border border-primary/40 bg-primary/10 transition-colors duration-300 group-hover:border-primary/70 group-hover:bg-primary/15">
